        ...
        <nav className="bg-gray-800 w-screen">
          <div className="flex items-center pl-8 h-14">
            <div className="flex space-x-4">
              <Link href="/">
                <span className="text-gray-300 hover:bg-gray-700 px-3 py-2">Home</span>
              </Link>
              <Link href="/blog-page">
                <span className="text-gray-300 hover:bg-gray-700 px-3 py-2">Blog</span>
              </Link>
              <Link href="/contact-page">
                <span className="text-gray-300 hover:bg-gray-700 px-3 py-2">Contact</span>
              </Link>
            </div>
          </div>
        </nav>
